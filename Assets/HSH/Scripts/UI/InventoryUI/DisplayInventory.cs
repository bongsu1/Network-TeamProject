...
//            img.sprite = inventory.database.GetItem[itemsDisplayed[obj].item.Id].uiDisplay; // 여기서 드래그시작할때 아이템 일러가 같이 움직이게 하는데
...
//        {
//            inventory.SwapItems(itemsDisplayed[obj], itemsDisplayed[mouseItem.hoverObj]); // 아이템 슬롯 이동
//        }
//        else
//        {
