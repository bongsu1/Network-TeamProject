...
public class NewPlayer : MonoBehaviourPun, IPointerClickHandler
{
    [Header("Componet")]
    ...
    [SerializeField] PopUpUI InvenUIViewer;
    [SerializeField] PopUpUI EquipUIViewer;
    ...
    private void Start()
    {
        if (photonView.IsMine)
        {
            ...
            Manager.Inven.MyUserID = this.GetComponent<PhotonView>().ViewID;
        }
    }
    private void Update()
    {
    ...
    private void OnDisable()
    {
        ...
        if (photonView.IsMine)
        {
            ...
            myTradeInven.Container.Clear();
            opponentTradeInven.Container.Clear();
        }
    ...
    {
        isActivated = true;
        Manager.UI.ShowPopUpUI(InvenUIViewer);
    }
